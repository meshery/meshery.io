...
<style>
    ...
    :root {
        ...
        --background-hover-primary: #f5f5f5;
    ...
    --background-primary: linear-gradient(to right top, #3d3d3d, #343434, #2b2b2b, #222222, #1a1a1a, #181818, #161616, #141414, #181818, #1c1c1c, #212121, #252525);
    --background-hover-primary: #1e1e1e;
            ...
            <div class="container">
                ...
                <div class="blog-post-section">
                    <div class="blog-post-header">
                        ...
                        <button class="btn" style="background-color: var(--background-primary);" ><a href="/blog/categories/kubecon/"> kubecon </a></button>
                        &nbsp; <button class="btn" style="background-color: var(--background-primary);"><a href="/blog/categories/events/"> events </a></button>
                    ...
                    <button class="btn" ><a style="color: var(--text-primary);" href="/blog/2025/03/2025-03-27-meshery-at-kubecon-eu-2025-security-slam/"> Read More </a></button>
                </div>
