...
The Meshery UI receives a major refresh with the adoption of the [Sistent design system](https://meshery.io/projects/sistent) and an in-progress migration to Material UI v5.
...
As a community, we've been fortunate to welcome new Meshery Maintainers, [Sangram Rath](https://meshery.io/community/members/sangram-rath) and [Matthieu Evrin](https://meshery.io/community/members/matthieu-evrin), and [Yash Sharma](https://meshery.io/community/members/yash-sharma). We are grateful for their stewardship and look forward to their continued pathpaving in our next release.
