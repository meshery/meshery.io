...
<p>
  Release Channels offer a subscription where users can subscribe to a specific  release channel and get notified when a new release is available. This is  useful for users who want to stay up to date with the latest Meshery features, while also providing flexibility for users who want to stay on a specific version of Meshery.
