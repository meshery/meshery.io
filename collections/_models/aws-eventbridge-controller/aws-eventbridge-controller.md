...
- name: iam-role-selector
  colorIcon: assets/images/integration/aws-eventbridge-controller/components/iam-role-selector/icons/color/iam-role-selector-color.svg
  whiteIcon: assets/images/integration/aws-eventbridge-controller/components/iam-role-selector/icons/white/iam-role-selector-white.svg
  description: 
componentsCount: 7
relationships: 
- type: "binding"
