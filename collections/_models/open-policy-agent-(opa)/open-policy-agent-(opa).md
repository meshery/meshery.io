...
- name: provider-pod-status
  colorIcon: assets/images/integration/open-policy-agent-(opa)/components/provider-pod-status/icons/color/provider-pod-status-color.svg
  whiteIcon: assets/images/integration/open-policy-agent-(opa)/components/provider-pod-status/icons/white/provider-pod-status-white.svg
  description: 
componentsCount: 18
relationships: 
